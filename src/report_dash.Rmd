...
.components = components(rgraph)$no
# save total network
.bac_net = rgraph
...
| Components | `r ifelse(components(.bac_net)$no == 0, 0, paste0("<span style='color:red'>", components(.bac_net)$no, "</span>"))` | 
| Isolates | `r ifelse(as.numeric(table(degree(.bac_net) == 0)["TRUE"]) == 0, 0, paste0("<span style='color:red'>", as.numeric(table(degree(.bac_net) == 0)["TRUE"]), "</span>"))` |
